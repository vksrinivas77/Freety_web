        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="/our-salads" className="text-gray-300 hover:text-green-400 transition-colors">Our Salads</a></li>
              <li><a href="/subscription" className="text-gray-300 hover:text-green-400 transition-colors">Subscription</a></li>
